...
public class UrlSetEvent extends AbstractPageObjectEvent {

    private static final String MESSAGE_FORMAT = "changed url of %s from '%s' to '%s' by trying to set it to '%s'";

    private final String before;
    private final String after;
    private final String textToSet;

    public UrlSetEvent (PageObject pageObject, String before, String after, String textToSet) {
        super(pageObject);
        this.before = before;
        this.after = after;
